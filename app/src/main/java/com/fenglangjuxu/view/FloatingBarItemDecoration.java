...
public class FloatingBarItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public FloatingBarItemDecoration(Context context, Map<Integer, String> list) {
        ...
        this.mDecorationHeight = resources.getDimensionPixelSize(R.dimen.item_decoration_normal_height);
        mBackgroundPaint = new Paint();
        mBackgroundPaint.setColor(ContextCompat.getColor(mContext, R.color.white));

        mTextPaint = new Paint();
        mTextPaint.setColor(ContextCompat.getColor(mContext, R.color.textBlack));
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        outRect.set(0, mList.containsKey(position) ? mTitleHeight : mDecorationHeight, 0, 0);
    }
